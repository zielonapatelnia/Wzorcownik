...
import com.zielonapatelnia.math.ObliczaniePolaProstokąta;

public class LayoutPoleProstokąt implements ActionListener  {
	...
	public void actionPerformed(ActionEvent e) {
			...
			if (z == jbOblicz)
			{
				...
				ObliczaniePolaProstokąta obiekt = new ObliczaniePolaProstokąta(a,b);
