...
import com.zielonapatelnia.math.ObliczanieObwódKwadrat;

public class LayoutObwódKwadrat implements ActionListener {
	
	JLabel jlNagłówek, jlWynik;
	JButton jbOblicz;
	JTextField jtfWynik, jtfWartość;

	public LayoutObwódKwadrat()
	{
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (z == jbOblicz)
		{
			...
			ObliczanieObwódKwadrat obiekt = new ObliczanieObwódKwadrat(a);
